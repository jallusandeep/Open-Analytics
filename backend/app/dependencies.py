...
def get_current_user(
    ...
    app_name = "admin" if path.startswith(("/api/v1/admin/", "/api/v1/data/", "/api/v1/connections/upstox")) else "recom" if path.startswith(("/api/v1/quant-research/", "/api/v1/data-quality/", "/api/v1/returns/", "/api/v1/risk/", "/api/v1/liquidity/")) else None
