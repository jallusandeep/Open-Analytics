      ...
      {viewOptions.map((option) => {
        ...
        return (
          <button
            ...
            className={`${oaTabStyles.button} ${isActive ? oaTabStyles.active : oaTabStyles.inactive
              } whitespace-nowrap`}
          >
...
function ScheduleManagerModal({
  ...
  function renderScheduleCell(schedule, column) {
    if (column.key === "schedule_time") {
      ...
      return (
        <span
          className={`truncate oa-code-font font-semibold ${isEditing ? "text-sky-200" : "text-cyan-200"
            }`}
        >
    ...
    return (
      <div className="flex justify-end gap-1.5">
        <button
          ...
          className={`flex h-8 w-8 items-center justify-center rounded border outline-none transition disabled:cursor-not-allowed disabled:opacity-60 ${schedule.is_active
      ...
      <div className="space-y-4 oa-table-font">
        <div className="w-full bg-black">
          ...
          {schedules.length === 0 ? (
            ...
            <div
              className={`-mx-4 w-[calc(100%+2rem)] border-y border-oa-border bg-black [&>div]:w-full [&>div]:rounded-none [&>div]:border-0 [&>div]:bg-transparent ${schedules.length > 4
              ...
              (item) => {
                ...
                return (
                  <button
                    ...
                    className={`flex h-8 min-w-8 items-center justify-center rounded border px-2 text-[12px] font-semibold outline-none transition ${active
