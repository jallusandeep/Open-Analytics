...
export function refreshAutomatedStockPredictions() {
  return axiosClient.post("/quant-research/predictions/refresh", null, {
    params: { limit: 1000, rebuild: true, include_deep_learning: true, train_missing_models: false }
  });
}
